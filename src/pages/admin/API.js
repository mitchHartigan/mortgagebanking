...
export const REJECT_PENDING_ACRONYM = async (acronym) => {
  const result = await fetch(
    "https://md5rhmga23.execute-api.us-west-2.amazonaws.com/production/rejectPendingAcronym",
    {
      method: "POST",
...
export const ACCEPT_PENDING_ACRONYM = async (acronym) => {
  const result = await fetch(
    "https://md5rhmga23.execute-api.us-west-2.amazonaws.com/production/acceptPendingAcronym",
    {
      method: "POST",
      body: JSON.stringify(acronym),
      headers: {
